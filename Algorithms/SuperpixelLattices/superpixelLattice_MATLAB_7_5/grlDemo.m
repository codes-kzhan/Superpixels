function grlDemo
% GRLDEMO versn 0.1 win32 MATLAB 7.5 - stable but very little error checking!
...
% 
% The boundary cost map (bndCostMap) is just the complement of this so that
...
% 
% BNDCOSTMAP - boundary strength image m x n [0-255]
...
%       [superPixels paths] = grl(bndCostMap,25,25,1,80,0.4);
...
%   and object boundaries. CVPR, 2:1964–1971, 2006.
