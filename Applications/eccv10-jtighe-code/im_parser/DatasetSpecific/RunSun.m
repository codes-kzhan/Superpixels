...
UseClassifier = [1 0];
%testSetNum = 3; %indoor
%HOMEIMAGES = fullfile(HOME,'ImagesIndoor');

%testSetNum = 2; %outdoor
%HOMEIMAGES = fullfile(HOME,'ImagesOutdoor');
