...
for ls = UseGlobalSVM
    ...
    [ittResult{ls}(1).svm  ittResult{ls}(1).tpr ittResult{ls}(1).fpr] = TrainGlobalSVMBasic(trainGlobalDesc, trainLabels, valGlobalDesc, valLabels, testGlobalDesc, testLabels,  descList);
    ...
    for i = 2:numLabels
        ...
        for c = 1:numClusters
            ...
            if(isempty(prevC))
                ...
                [ittResult{ls}(i).svm{c} tprt fprt] = TrainGlobalSVMBasic(trainGlobalDesc, newtrainLabels, valGlobalDesc, newvalLabels, testGlobalDesc, newtestLabels,  descList);
